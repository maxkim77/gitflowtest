console.log("js가 연결 되었습니다");

const data = {
    "id":1,
    "productName":"버그를 버그잡는 개리씨 키링 개발자 키링 금속키링",
    "price":12500,
    "stockCount":100,
    "thumbnailImg":"asset/img/1/thumbnaillmg.jpg",
    "option":[],
    "discountRate":0,
    "shippingFee":1500,
    "detaillnfolmage":[
...
function createProductCard(imgUrl, price, productName, onClick){
    ...
    // $productCard.append($thumbnailmg, $productName, $price)
...
function main(){
    ...
    fetch(BASE_URL+"mall").then((res)=>{
        ...
        const onClick = async (e)=>{
            ...
            json.detailInfomage.forEach(imgUrl=>{
